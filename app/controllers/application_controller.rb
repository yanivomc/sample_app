class ApplicationController < ActionController::Base
  ...
  include SessionsHelper #By including the seesionHelper module in the Application Controller, we're makeing sure the sessionHelper will be exposed to the all MVC
